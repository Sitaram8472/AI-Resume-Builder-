                ...
                <div className="flex items-center">
                  {activeSectionsIndex !== 0 && (
                    <button
                      ...
                      disabled={activeSectionsIndex === 0}
                    >
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1 p-3 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 transition-all ${activeSectionsIndex === sections.length - 1}`}
